...
{
    public static string luaDir = Application.dataPath + "/ProjectRes/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/GameFramework/Scripts/GameCore/GameFramework/Lua/ToLua/Lua/";        //tolua lua文件目录
